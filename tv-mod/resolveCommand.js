        ...
        if (window._yttv[key] && window._yttv[key].instance && window._yttv[key].instance.resolveCommand) {
            ...
            window._yttv[key].instance.resolveCommand = function (cmd, _) {
                ...
                if (cmd.setClientSettingEndpoint) {
                    ...
                    if (typeof window.pulseMarkWatched === 'function') {
                        window.pulseMarkWatched(cmd.watchEndpoint.videoId);
                    }
...
function customAction(action, parameters) {
    switch (action) {
        case 'CLIENT_SIGNAL_PULSE_NAV':
            window.__PULSE_NAV__ = true;
            console.log('[PulseTube TV] CLIENT_SIGNAL_PULSE_NAV custom action triggered. window.__PULSE_NAV__ set to true.');
            break;
        ...
        case 'TT_SPEED_SETTINGS_SHOW':
            ...
            break;
        case 'TT_SET_SORT':
            if (typeof window.setPulseFeedsSort === 'function') {
                window.setPulseFeedsSort(parameters);
            }
            break;
        case 'PULSE_SORT_SHOW':
            if (typeof window.showPulseSortMenu === 'function') {
                window.showPulseSortMenu();
            }
            break;
