...
export default function modernUI(update, parameters) {
    const settings = [
        ...
        {
            name: 'Pulse Feed Sort Mode',
            icon: 'SORT',
            value: null,
            menuId: 'tt-pulse-sort',
            menuHeader: {
                title: 'Pulse Feed Sort Mode',
                subtitle: 'Change how videos are sorted in the Pulse TV Feed'
            },
            options: [
                { name: 'Viral Score', key: 'pulseSort', value: 'viral' },
                { name: 'Velocity (Views/Hr)', key: 'pulseSort', value: 'vph' },
                { name: 'Total Views', key: 'pulseSort', value: 'views' },
                { name: 'Performance Ratio', key: 'pulseSort', value: 'performance' },
                { name: 'Current VPH', key: 'pulseSort', value: 'current_vph' }
            ]
        },
        {
